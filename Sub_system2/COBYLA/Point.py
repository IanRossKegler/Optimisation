...
class Point:
    ...
    def spl(self, l1, r1, x0, y0, l, w):
        r2 = self.direct_l(x0, y0)
        spl_direct = l1 - abs(20*np.log(r1/r2))

        r2a = self.first_a(x0, y0)
        r2b = self.first_b(x0, y0, w)
        r2c = self.first_c(x0, y0, l)
        r2d = self.first_d(x0, y0)
        spl_for_a = l1 - abs(20*np.log(r1/r2a))
        spl_for_b = l1 - abs(20*np.log(r1/r2b))
        spl_for_c = l1 - abs(20*np.log(r1/r2c))
        spl_for_d = l1 - abs(20*np.log(r1/r2d))
        spl_for = spl_for_a + spl_for_b + spl_for_c + spl_for_d

        self.spl_direct = spl_direct
        self.spl_for = spl_for
        self.spl_total = spl_for + spl_direct
